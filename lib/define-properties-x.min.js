 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),isUndefined=_dereq_("validate.io-undefined"),forEach=_dereq_("array-for-each-x"),defineProperty=_dereq_("object-define-property-x"),isFalsey=_dereq_("is-falsey-x"),getKeys=_dereq_("get-own-enumerable-keys-x"),$property=function property(object,prop,value,force){prop in object&&isFalsey(force)||defineProperty(object,prop,{configurable:!0,enumerable:!1,value:value,writable:!0})};module.exports={properties:function properties(object,map,predicates){var preds=isUndefined(predicates)?{}:predicates;forEach(getKeys(map),function(name){var predicate=preds[name];$property(object,name,map[name],isFunction(predicate)&&predicate())})},property:$property}},{"array-for-each-x":3,"get-own-enumerable-keys-x":8,"is-falsey-x":18,"is-function-x":20,"object-define-property-x":34,"validate.io-undefined":55}],2:[function(_dereq_,module,exports){/**
